...
<div class="d-table">
    ...
    <div class="d-tr">
        ...
        <div class="d-th"><select input type="cid" name="cid"><option value="0" selected>City</option>
                <?php
    ...
    foreach ($result as $c => $value) {
        ?>
        <div class='d-tr'>
            <div class='d-td'><?= $value['id'] ?></div>
            <div class='d-td'><?= $value['name'] ?></div>
            <div class='d-td'><?= $value['age'] ?></div>
            <div class='d-td'><?= $value['cid'] ?></div>
            <div class='d-td'><a href="/edit?id=<?= $value['id'] ?>">Edit</a></div>
            <div class='d-td'><a onclick="return confirm('Are you sure?')"
                                 href="/delete?id=<?= $value['id'] ?>">Delete</a></div>
        </div>
    <?php } ?>
